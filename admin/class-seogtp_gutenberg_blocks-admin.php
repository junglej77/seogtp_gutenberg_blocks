 ...
 * @subpackage Seogtp_gutenberg_blocks/admin
 */
...
class Seogtp_gutenberg_blocks_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Seogtp_gutenberg_blocks_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Seogtp_gutenberg_blocks_Loader will then create the relationship
