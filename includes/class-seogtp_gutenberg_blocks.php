...
class Seogtp_gutenberg_blocks {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Seogtp_gutenberg_blocks_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Seogtp_gutenberg_blocks_Loader. Orchestrates the hooks of the plugin.
	 * - Seogtp_gutenberg_blocks_i18n. Defines internationalization functionality.
	 * - Seogtp_gutenberg_blocks_Admin. Defines all hooks for the admin area.
	 * - Seogtp_gutenberg_blocks_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Seogtp_gutenberg_blocks_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Seogtp_gutenberg_blocks_Loader    Orchestrates the hooks of the plugin.
	 */
